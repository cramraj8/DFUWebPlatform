...
def display_form(request):
    ...
    patientId = database.child('patients').child('reports').child('patientId').get().val()
    fullName = database.child('patients').child('reports').child('fullName').get().val()
    email = database.child('patients').child('reports').child('email').get().val()
    address = database.child('patients').child('reports').child('address').get().val()
    age = database.child('patients').child('reports').child('age').get().val()
    DOB = database.child('patients').child('reports').child('DOB').get().val()
    phone = database.child('patients').child('reports').child('phone').get().val()
    dateOfFirstVisit = database.child('patients').child('reports').child('dateOfFirstVisit').get().val()

    height = database.child('patients').child('reports').child('height').get().val()
    weight = database.child('patients').child('reports').child('weight').get().val()
    bmi = database.child('patients').child('reports').child('bmi').get().val()
    dateOfLastVisit = database.child('patients').child('reports').child('dateOfLastVisit').get().val()
    medicalHistory = database.child('patients').child('reports').child('medicalHistory').get().val()

    diabeticType = database.child('patients').child('reports').child('diabeticType').get().val()
    dateOfIdentification = database.child('patients').child('reports').child('dateOfIdentification').get().val()
    DFUCondition = database.child('patients').child('reports').child('DFUCondition').get().val()
...
def post_create(request):
    ...
    database.child('patients').child('reports').set(data)
    # name = database.child('users').child(a).child('details').child('name').get().val()
    name = database.child('patients').child('details').child('fullName').get().val()
...
# def get_data(request):
#     # fullName = request.POST.get('fullname')
#     name = database.child('patients').child('reports').child('fullName').get().val()
...
#     # return render(request, 'formdata.html', {'e': users.val()})
#     return render(request, 'formdata.html', {'e': name})
